...
const CALCULATOR_ASSETS_LIST: RecommendedAsset[] = [
  {
    id: "calc-1",
    name: "Master KV creation (non-NDA)",
    description: "Master KV creation (non-NDA)",
    poundPrice: 135.06,
  },
  {
    id: "calc-2",
    name: "Static KV adaptation (non-NDA)",
    description: "Static KV adaptation (non-NDA)",
    poundPrice: 13.51,
  },
  {
    id: "calc-3",
    name: "Status KV adaptation (non-NDA)",
    description: "Status KV adaptation (non-NDA)",
    poundPrice: 13.51,
  },
  {
    id: "calc-4",
    name: "Master KV animation creation (non-NDA)",
    description: "Master KV animation creation (non-NDA)",
    poundPrice: 450.20,
  },
  {
    id: "calc-5",
    name: "Master KV animation adaptation (non-NDA)",
    description: "Master KV animation adaptation (non-NDA)",
    poundPrice: 13.51,
  },
  {
    id: "calc-6",
    name: "PPT Files (non-NDA)",
    description: "PPT Files (non-NDA)",
    poundPrice: 135.06,
  },
  {
    id: "calc-7",
    name: "Roundel (non-NDA)",
    description: "Roundel (non-NDA)",
    poundPrice: 13.51,
  },
  {
    id: "calc-8",
    name: "Urgency tag (non-NDA)",
    description: "Urgency tag (non-NDA)",
    poundPrice: 13.51,
  },
  {
    id: "calc-9",
    name: "Video creation (non-NDA)",
    description: "Video creation (non-NDA)",
    poundPrice: 450.20,
  },
  {
    id: "calc-10",
    name: "Video adaptation (non-NDA)",
    description: "Video adaptation (non-NDA)",
    poundPrice: 13.51,
  },
  {
    id: "calc-11",
    name: "Watermarked files (non-NDA)",
    description: "Watermarked files (non-NDA)",
    poundPrice: 2,
  },
];
