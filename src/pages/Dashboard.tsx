                ...
                <div className="flex flex-col lg:flex-row gap-4">
                  ...
                  <div className="flex flex-col sm:flex-row lg:flex-col gap-2.5 lg:w-[25%]">
                    <button 
                      ...
                      className="btn w-full sm:flex-1 lg:flex-none h-[48px] bg-transparent border border-[#ffb546] rounded-[28px] flex items-center justify-center gap-[10px] px-[24px] py-[18px] hover:bg-[#ffb546]/10 transition"
                    >
                    ...
                    <button
                      ...
                      className="btn w-full sm:flex-1 lg:flex-none h-[48px] bg-transparent border border-[#03b3e2] rounded-[28px] flex items-center justify-center gap-[10px] px-[24px] py-[18px] hover:bg-[#03b3e2]/10 transition"
                    >
                    ...
                    <button 
                      ...
                      className="w-full sm:flex-1 lg:flex-none h-[48px] bg-[#ffb546] rounded-[28px] flex items-center justify-center gap-[10px] px-[24px] py-[18px] hover:bg-gray-50 transition card-brief"
                    >
                      <span className="text-base font-semibold leading-[23.94px] text-black whitespace-nowrap">
                        View all
                      </span>
              ...
              <div className="section bg-white rounded-xl p-4 md:p-6 flex flex-col gap-4 border-c">
                ...
                <div className="grid gap-4 md:grid-cols-3">
                  ...
                  <div className="board-card board-c bg-[#f9f9f9] rounded-xl p-5 flex flex-col gap-2.5 relative overflow-clip">
                    ...
                    <svg className="absolute right-[-45px] top-[-0px] sm:top-[-34px] md:top-[0px] w-[250px] h-[114px] sm:w-[175px] sm:h-[190px] md:w-[212px] md:h-[114px]"  xmlns="http://www.w3.org/2000/svg" width="106" height="115" viewBox="0 0 106 115" fill="none">
                      <path d="M112.364 152.333H27.4008C12.2489 152.333 0 140.227 0 125.251V114.054C0 107.966 3.75254 102.507 9.48759 100.268L70.3783 71.7162C82.9812 66.7476 82.9811 49.1826 70.449 44.144L9.41672 15.0322C3.75247 12.7929 0 7.33441 0 1.24614V-9.25089C0 -24.2267 12.2489 -36.3333 27.4008 -36.3333H112.364C118.312 -36.3333 124.118 -34.4437 128.861 -30.8748L201.364 36.3762C215.879 47.2232 215.879 68.7071 201.364 79.554L128.861 146.805C124.118 150.374 118.312 152.263 112.364 152.263V152.333Z" fill="#ffb546"/>
                    </svg>
                  </div>
                  {/* For review */}
